...
export default function MountChecklistPage() {
  ...
  return (
    <>
      <Head>
        <title>【FF11】マウント一覧 チェックリスト | モグログ</title>
        <meta name="description" content="FF11のマウント取得状況を管理できるチェックリスト。入手方法や銀チケット有無で絞り込みも可能。あなたのコレクション進捗を可視化！" />
        <link rel="canonical" href="https://moglog.jp/checklist/mount" />
        <meta property="og:type" content="website" />
        <meta property="og:title" content="【FF11】マウント一覧 チェックリスト | モグログ" />
        <meta property="og:description" content="FF11のマウント取得状況を管理できるチェックリスト。入手方法や銀チケット有無で絞り込みも可能。あなたのコレクション進捗を可視化！" />
        <meta property="og:url" content="https://moglog.jp/checklist/mount" />
        <meta property="og:site_name" content="モグログ" />
        <meta property="og:image" content="https://moglog.jp/moglogicon.png" />
        <meta name="robots" content="index,follow" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="【FF11】マウント一覧 チェックリスト | モグログ" />
        <meta name="twitter:description" content="FF11のマウント取得状況を管理できるチェックリスト。入手方法や銀チケット有無で絞り込みも可能。あなたのコレクション進捗を可視化！" />
        <meta name="twitter:image" content="https://moglog.jp/moglogicon.png" />
      </Head>
