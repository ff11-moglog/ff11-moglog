...
export default function FaceChecklistPage() {
  ...
  return (
    <>
      <Head>
        <title>【FF11】フェイス一覧 チェックリスト | モグログ</title>
        <meta name="description" content="FF11のフェイス取得状況を管理できるチェックリスト。入手方法や戦闘タイプで絞り込みも可能。あなたのコレクション進捗を可視化！" />
        <link rel="canonical" href="https://moglog.jp/checklist/face" />
        <meta property="og:type" content="website" />
        <meta property="og:title" content="【FF11】フェイス一覧 チェックリスト | モグログ" />
        <meta property="og:description" content="FF11のフェイス取得状況を管理できるチェックリスト。入手方法や戦闘タイプで絞り込みも可能。あなたのコレクション進捗を可視化！" />
        <meta property="og:url" content="https://moglog.jp/checklist/face" />
        <meta property="og:site_name" content="モグログ" />
        <meta property="og:image" content="https://moglog.jp/moglogicon.png" />
        <meta name="robots" content="index,follow" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="【FF11】フェイス一覧 チェックリスト | モグログ" />
        <meta name="twitter:description" content="FF11のフェイス取得状況を管理できるチェックリスト。入手方法や戦闘タイプで絞り込みも可能。あなたのコレクション進捗を可視化！" />
